...
describe('FieldNames', () => {
  it('getStringFields()', () => {
    const type = FieldNames.getStringFields(prepareCommonOpts(schemaComposer, opts));
  ...
  it('getNumericFields()', () => {
    const type = FieldNames.getNumericFields(prepareCommonOpts(schemaComposer, opts));
    expect(type).toBeInstanceOf(EnumTypeComposer);
    expect(type.getDescription()).toBe('Avaliable fields from mapping.');
  ...
  it('getDateFields()', () => {
    const type = FieldNames.getDateFields(prepareCommonOpts(schemaComposer, opts));
    expect(type).toBeInstanceOf(EnumTypeComposer);
    expect(type.getDescription()).toBe('Avaliable fields from mapping.');
  ...
  it('getBooleanFields()', () => {
    const type = FieldNames.getBooleanFields(prepareCommonOpts(schemaComposer, opts));
    expect(type).toBeInstanceOf(EnumTypeComposer);
    expect(type.getDescription()).toBe('Avaliable fields from mapping.');
  ...
  it('getGeoPointFields()', () => {
    const type = FieldNames.getGeoPointFields(prepareCommonOpts(schemaComposer, opts));
    expect(type).toBeInstanceOf(EnumTypeComposer);
    expect(type.getDescription()).toBe('Avaliable fields from mapping.');
  ...
  it('getNestedFields()', () => {
    const type = FieldNames.getNestedFields(prepareCommonOpts(schemaComposer, opts));
    expect(type).toBeInstanceOf(EnumTypeComposer);
    expect(type.getDescription()).toBe('Avaliable fields from mapping.');
  ...
  it('getIpFields()', () => {
    const type = FieldNames.getIpFields(prepareCommonOpts(schemaComposer, opts));
    expect(type).toBeInstanceOf(EnumTypeComposer);
    expect(type.getDescription()).toBe('Avaliable fields from mapping.');
  ...
  it('getAllFields()', () => {
    const type = FieldNames.getAllFields(prepareCommonOpts(schemaComposer, opts));
    expect(type).toBeInstanceOf(EnumTypeComposer);
    expect(type.getDescription()).toBe('Avaliable fields from mapping.');
