import { Request, Response } from 'apollo-server-types/src/node_modules/apollo-server-env';
...
import { KeyValueCache } from 'apollo-server-types/src/node_modules/apollo-server-caching';
import { Trace } from 'apollo-server-types/src/node_modules/apollo-engine-reporting-protobuf';
...
export declare type GraphQLRequestContextWillSendResponse<TContext> = WithRequired<GraphQLRequestContext<TContext>, 'metrics' | 'response'>;
export {};
