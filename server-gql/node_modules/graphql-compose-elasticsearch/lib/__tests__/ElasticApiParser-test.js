...
describe('ElasticApiParser', () => {
  ...
  describe('static methods', () => {
    ...
    describe('findApiVersionFile()', () => {
      it('should find proper version in elasticsearch 12.x', () => {
        const {
          loadApiListFile
        } = _ElasticApiParser.default; // $FlowFixMe
  ...
  describe('reassembleNestedFields()', () => {
    ...
    it('should combine nested field in GraphQLObjectType', () => {
      ...
      expect(reFields.cat.type).toBeInstanceOf(_graphqlCompose.ObjectTypeComposer);
      ...
      expect(reFields.index.type).toBeInstanceOf(_graphqlCompose.ObjectTypeComposer);
